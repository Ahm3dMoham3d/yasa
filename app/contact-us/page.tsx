      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-2 flex items-center gap-2">
            CEO - <span className="text-primary">+20</span> 10 2601 2050 / WB
          </p>
          <p className="mt-2">
            Operation - <span className="text-primary">+20</span> 10 7005 0622
          </p>
          <p className="mt-2">
            Info - <span className="text-primary">+20</span> 10 3378 7227
          </p>
          <p className="mt-2">
            Shipping <span className="text-primary">+20</span> 10 1772 8615
          </p>
        </div>
